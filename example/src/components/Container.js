...
const transitionStyles = {
  entering: { opacity: 0,  transition: 'all 600ms' },
  entered:  { opacity: 1 },
        ...
        return (
            <div>
                <div style={{display: 'flex', border: '1px solid grey'}}>
                    <img src={menuIcon} style={{width: '50px', height: '50px', marginTop: '8px'}} onClick={() => this.imageHandler()}/>
                    
                    {/* <Transition in={menuIsOn} timeout={duration}>
                    {(state) => (
                      <div style={{
                        ...defaultStyle,
                        ...transitionStyles[state]
                      }}> */}
                        {menuIsOn ? <div className={styles.listview} style={{position: 'absolute', left: '180px', top: '40px', zIndex: '200',background: '#0DDBD5', }}>
                     <li><a href="www.google.co.in">Google</a></li>
                     <li><a href="www.google.co.in">yahoo</a></li>
                     <li><a href="www.google.co.in">Bingo</a></li>
                     <li><a href="www.google.co.in">Amazon</a></li>
                    </div>
                      : null}
                    {/* )}
                  </Transition> */}
